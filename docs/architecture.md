...
Consuming repos pin to a release tag in the `uses:` line:

```yaml
uses: my-org/sonar-fix/.github/workflows/fix.yml@v1
```

Future releases increment the tag (`v1.1`, `v2`, etc.). Use `@main` in development forks; pin to a tag in production.
